...
imageLoader.addEventListener("change", steganoEncryptImage, false);
...
imageLoader2.addEventListener("change", steganoDecryptImage, false);

function steganoEncryptImage(e) {
...
function steganoDecryptImage(e) {
